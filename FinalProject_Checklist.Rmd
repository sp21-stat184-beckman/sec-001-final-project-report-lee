...
(A) .Rmd Line number(s) for general data wrangling: 48, 52, 67


(B) .Rmd Line number(s) for a join operation: 63


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): 98


(D) .Rmd Line number(s) for use of regular expressions: 82, 95


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 67-71
