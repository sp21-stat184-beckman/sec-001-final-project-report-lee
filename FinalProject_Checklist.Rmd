...
(A) .Rmd Line numbers where at least two different data sources are imported: 28-34


(B) .Rmd Line numbers for inspecting data intake: 39, 44


### Data Wrangling / Cleaning / ect (5 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 55, 59, 74


(B) .Rmd Line number(s) for a join operation: 70


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): 113


(D) .Rmd Line number(s) for use of regular expressions: 89, 111


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 74-78
...
(A) .Rmd Line numbers for use of multiple different geoms: 49, 102

(B) .Rmd Line number(s) for use of multiple aesthetics: 48

(C) .Rmd Line number(s) for use of layered graphics: 47 - 50
